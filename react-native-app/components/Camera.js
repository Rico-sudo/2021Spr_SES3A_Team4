      ...
      <View style={styles.container}>
        ...
        <View style={styles.container}>
          ...
          {isPreview && resultObject && (
            <TouchableOpacity
            onPress={() => navigation.navigate('SnakeInfo', {commonName: resultObject?.commonName, scientificName: resultObject?.scientificName, family: resultObject?.family, genus: resultObject?.genus, moreInfo: resultObject?.moreInfo, venomousInfo: resultObject?.venomousInfo, id: resultObject?._id, dangerRating: resultObject?.dangerRating})}
